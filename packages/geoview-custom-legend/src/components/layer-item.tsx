...
import { useGeoViewMapId } from 'geoview-core/core/stores';
...
export function LegendLayerItem({ item }: LegendLayerItemProps): JSX.Element | undefined {
  ...
  return <LegendLayer layerPath={item.layerPath} showControls={true} mapId={mapId} containerType={CONTAINER_TYPE.APP_BAR} />;
}
