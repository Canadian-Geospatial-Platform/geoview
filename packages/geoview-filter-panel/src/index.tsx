    ...
    return {
      en: {
        FilterPanel: {
          ...
          expandFilters: 'Expand layer filters',
          collapseFilters: 'Collapse layer filters',
          expand: 'Expand',
          collapse: 'Collapse',
          nullValue: '(null)',
          available: 'Available',
      ...
      fr: {
        FilterPanel: {
          ...
          expandFilters: 'Développer les filtres de couche',
          collapseFilters: 'Réduire les filtres de couche',
          expand: 'Développer',
          collapse: 'Réduire',
          nullValue: '(nul)',
