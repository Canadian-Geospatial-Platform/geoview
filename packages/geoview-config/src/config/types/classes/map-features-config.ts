import { Cast, TypeJsonObject } from 'geoview-core/src/core/types/global-types';
import {
  TypeAppBarProps,
  TypeDisplayLanguage,
  TypeDisplayTheme,
...
import { TypeJsonArray } from '../config-types';
...
export class MapFeaturesConfig {
  ...
  set displayLanguage(newValue: TypeDisplayLanguage) {
