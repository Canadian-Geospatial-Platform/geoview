...
import { createLocalizedString } from 'geoview-core/src/core/utils/utilities';
import { CV_CONST_LAYER_TYPES, CV_CONST_SUB_LAYER_TYPES } from '../types/config-constants';
import { TypeOfServer, TypeTileGrid } from '../types/map-schema-types';
import { TypeJsonArray, TypeJsonObject, toJsonObject } from '../types/config-types';
...
export class UUIDmapConfigReader {
   ...
   */
  private static getLayerConfigFromResponse(result: AxiosResponse<TypeJsonObject>, lang: string): AbstractGeoviewLayerConfig[] {
    // If invalid response
