...
![]({{assetsURL}}/img/guide/datatable/settings.png)
...
| <img src="{{assetsURL}}/img/guide/datatable/fullscreen.svg" width="30"/>    | Full screen     | Full screen presents layer content using the entire page. Full screen option is only available when the map is embedded into another page |
...
![]({{assetsURL}}/img/guide/datatable/filter_open.png)
