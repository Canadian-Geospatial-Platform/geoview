...
- Accepted file types are GeoJSON files (.json or .geojson), comma separated value files (.csv) with coordinate values, shapefiles (.shp), or ZIP files (.zip) containing a shapefile.
