...
export * from '@/api/events/payloads/clear-highlights-payload';
...
export * from '@/api/events/payloads/inter-draw-payload';
export * from '@/api/events/payloads/inter-modify-payload';
export * from '@/api/events/payloads/inter-select-payload';
export * from '@/api/events/payloads/inter-translate-payload';
