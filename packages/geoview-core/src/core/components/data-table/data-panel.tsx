...
export function Datapanel({ layerData, mapId, projectionConfig, layerKeys, layerId }: DatapanelProps) {
  ...
  return (
    <Box sx={{ backgroundColor: '#F1F2F5' }}>
      <Grid container spacing={2} sx={{ paddingTop: '3rem', paddingLeft: '1rem', paddingRight: '1rem' }}>
        <Grid item xs={3}>
      ...
      <Grid container sx={{ marginTop: '0.75rem' }}>
        ...
        <Grid item xs={9}>
          <Box sx={{ paddingRight: '1.5rem', marginBottom: '1rem', paddingLeft: '1rem' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <Typography component="p" sx={{ fontSize: '1.125rem', fontWeight: 'bold' }}>
                {layerKeys[selectedLayerIndex]}
              </Typography>
              <Typography component="p">Layer quick overview info</Typography>
