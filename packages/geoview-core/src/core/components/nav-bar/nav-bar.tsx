...
import { useStoreMapOverviewMapVisible } from '@/core/stores/states/map-state';
...
export type NavbarButtonGroup = Record<string, TypeButtonPanel | DefaultNavbar>;
/** All button panel groups indexed by group name. */
export type NavButtonGroups = Record<string, NavbarButtonGroup>;
...
export function NavBar(props: NavBarProps): JSX.Element {
  ...
  const isOverviewMapVisible = useStoreMapOverviewMapVisible();
      ...
      <Box key={groupName} sx={memoSxClasses.navBtnGroupColumns}>
        {columns.map((columnKeys, columnIndex) => (
          <ButtonGroup
            ...
            variant="contained"
            sx={[memoSxClasses.navBtnGroup, isOverviewMapVisible && memoSxClasses.navBtnGroupMultiColumn] as SxProps}
    ...
    <Box
      sx={
        [
          ...
          isOverviewMapVisible && memoSxClasses.navBarContainerWithOverview,
          isOverviewMapVisible && memoSxClasses.navBarContainerMultiColumn,
