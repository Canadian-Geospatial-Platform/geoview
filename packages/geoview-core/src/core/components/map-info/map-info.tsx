...
import { sxClassesMapInfo } from './map-info-style';
...
export function MapInfo(): JSX.Element {
  ...
  return (
    <Box id={`${mapId}-mapInfo`} sx={sxClassesMapInfo.mapInfoContainer} ref={mapInfoRef as MutableRefObject<HTMLDivElement>}>
      <MapInfoExpandButton />
      <Grid container justifyContent="space-between">
        ...
        <Grid container item md={11} spacing={2}>
          ...
          >
            <Grid item md={10}>
              <Box id="mouseAndScaleControls" sx={sxClassesMapInfo.mouseScaleControlsContainer}>
            ...
            {interaction === 'dynamic' && (
              <Grid item md={2}>
                <Box
                  sx={{
                    ...sxClassesMapInfo.rotationControlsContainer,
