...
const ResponsiveGridLayout = forwardRef(
  (
    ...
    const renderRightContent = (): JSX.Element => {
      ...
      // TODO: WCAG Issue #3116 - remove has-buttons class and refactor CSS once new guide buttons placement / focus trap is approved...
      // TODO: WCAG Issue #3116 - ... has-buttons is used so that separate css can be applied depending on where the buttons are located
