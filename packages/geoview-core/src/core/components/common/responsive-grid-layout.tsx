...
const ResponsiveGridLayout = forwardRef(
  (
    ...
    }, [isRightPanelVisible, hasContent, isGuideOpen, focusItem.activeElementId, containerType, selectedFooterLayerListItemId]);
    ...
    const renderRightContent = (): JSX.Element => {
      ...
      // Always wrap in FocusTrap but control activation with open prop
      // This prevents React tree restructuring which can cause focus loss
      // const wrappedMainContent = <FocusTrap open={shouldTrapFocus} disableAutoFocus>{mainContentBox}</FocusTrap>;
