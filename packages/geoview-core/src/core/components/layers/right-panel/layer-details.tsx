...
// TODO: WCAG - Fix layers.moreInfo button (button nested within a button)
// TODO: WCAG - Check all disabled buttons. They may need special treatment. Need to find instance in UI first)
