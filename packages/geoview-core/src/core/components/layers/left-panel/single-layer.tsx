      ...
      return (
        <>
          <IconButton
            ...
            onClick={(event) => handleReload(event)}
          >
            <LoopIcon />
          </IconButton>
    ...
    return (
      <Box>
        <IconButton
          ...
          onClick={(event) => handleZoomToLayerVisibleScale(event)}
        >
        ...
        {isLayerVisibleCapable && (
          <IconButton
            ...
            size="small"
            onClick={(event) => handleToggleVisibility(event)}
    ...
    if (layerChildren?.length) {
      return (
        <IconButton
          ...
          edge="end"
          size="small"
          onClick={(event) => handleExpandGroupClick(event)}
