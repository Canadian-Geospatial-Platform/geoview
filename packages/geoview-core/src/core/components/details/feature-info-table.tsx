...
import { isImage, stringify, generateId, sanitizeHtmlContent, enhanceLinksAccessibility } from '@/core/utils/utilities';
...
export const FeatureItem = memo(function FeatureItem({
  ...
  const linkifyOptions = useMemo(
    () => ({
      ...
      format: {
        url: (value: string) => `${t('general.view')} ${alias || value}`,
      },
