  ...
  return (
    <Box component="header" sx={sxClasses.notificationsHeader}>
      ...
      <Box>
        ...
        <IconButton tooltip={t('general.close')} aria-label={t('appbar.closeNotificationsDialog')} sx={{ ml: '0.25rem' }} onClick={onClose}>
          <CloseIcon />
        </IconButton>
      </Box>
    </Box>
          ...
          <Paper component="section" sx={sxClasses.notificationPanel}>
            ...
            <List sx={sxClasses.notificationsList} aria-live="polite" aria-relevant="all">
              {notifications.length > 0 ? (
                ...
                <Typography component="p" sx={{ padding: '10px 15px' }}>
