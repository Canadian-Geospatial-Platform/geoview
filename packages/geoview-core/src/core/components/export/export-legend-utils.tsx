...
function LegendContainerComponent({ layers }: LegendContainerProps): JSX.Element {
  ...
  const renderLayerIcon = (layer: TypeLegendLayer): JSX.Element => {
    ...
    // return <img src={imgUrl} alt={alt} style={getSxClasses(theme).legendLayerIcon} />;
    return <> </>;
  };
