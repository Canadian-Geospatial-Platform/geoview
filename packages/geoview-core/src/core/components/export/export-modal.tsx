...
export function ExportModal(): JSX.Element {
   ...
   */
  const memoFormatMenuItems = useMemo<TypeMenuItemProps[]>(
    () => [
   ...
   */
  const memoDpiMenuItems = useMemo<TypeMenuItemProps[]>(
    () => [
   ...
   */
  const memoQualityMenuItems = useMemo<TypeMenuItemProps[]>(
    () => QUALITY_OPTIONS.map((quality) => ({ item: { value: quality, children: `${quality}%` } })),
    []
  );
    ...
    >
        ...
        <Box sx={memoSxClasses.exportSettings}>
          ...
          <Box sx={memoSxClasses.exportOptions}>
            ...
            <Select
              ...
              label={t('exportModal.typeSelect')}
            ...
            {(exportFormat === 'png' || exportFormat === 'jpeg') && (
              <Select
                ...
                label={t('exportModal.valueSelect')}
          ...
          {(() => {
            ...
            if (pngPreviewUrls) {
              return pngPreviewUrls.map((imageUrl) => {
                ...
                return <Box component="img" key={key} src={imageUrl} alt="Export Preview" sx={memoSxClasses.mapPreview} />;
              });
            }
      ...
      <DialogActions sx={memoSxClasses.dialogActions}>
        ...
        <LoadingButton
          ...
          size="medium"
          sx={memoSxClasses.buttonContained}
