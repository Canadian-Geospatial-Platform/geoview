      ...
      <DialogContent dividers ref={dialogRef}>
        <Box ref={exportContainerRef} textAlign="center">
          ...
          <Box
            ...
            component="p"
            sx={{ margin: 0, marginBottom: '20px', fontSize: '0.7rem' }}
          >
            {t('mapctrl.disclaimer.message')}
          </Box>
          <Box textAlign="center">
            {mapAttributions.map((mapAttribution) => (
              <Box key={mapAttribution} component="p" sx={{ margin: 0, fontSize: '0.8rem' }}>
                {mapAttribution}
              </Box>
            ))}
          </Box>
          <Box textAlign="center" sx={{ marginBottom: '1rem', fontSize: '0.8rem' }}>
