  ...
  createAppbarPanel = (
    ...
    if (buttonProps && panelProps) {
      ...
      const buttonPanel: TypeButtonPanel = {
        buttonPanelId,
        panel: new PanelApi(panel, buttonPanelId, this.mapId),
        button,
        groupName: group,
      };
      ...
      api.event.emit(buttonPanelPayload(EVENT_NAMES.APPBAR.EVENT_APPBAR_PANEL_CREATE, this.mapId, buttonPanelId, group, buttonPanel));
