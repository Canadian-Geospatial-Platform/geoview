  ...
  createAppbarPanel = (
    ...
    if (buttonProps && panelProps) {
      ...
      const buttonPanel: TypeButtonPanel = {
        ...
        panel: new PanelApi(panel, theButtonId, this.mapId),
        button,
        groupName: group,
      };
      ...
      api.event.emit(buttonPanelPayload(EVENT_NAMES.APPBAR.EVENT_APPBAR_PANEL_CREATE, this.mapId, theButtonId, group, buttonPanel));
