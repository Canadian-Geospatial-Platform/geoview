...
const translations = {
  ...
  fr: {
    ...
    back: 'Retour',
    forward: 'En avant',
    animateForward: `Animer vers l'avant`,
    animateBackward: 'Animer en arrière',
...
export function TimeSlider(TimeSliderPanelProps: TimeSliderPanelProps) {
  ...
  const { range, defaultValue, minAndMax, field, singleHandle, values, filtering, delay } = sliderFilterProps;
      ...
      <div style={sxClasses.rightPanelContainer}>
        ...
        <Grid item xs={12}>
          <div style={{ textAlign: 'center', paddingTop: '20px' }}>
            ...
            <IconButton
              aria-label={isReversed ? translations[displayLanguage].animateForward : translations[displayLanguage].animateBackward}
              tooltip={isReversed ? translations[displayLanguage].animateForward : translations[displayLanguage].animateBackward}
              tooltipPlacement="top"
            ...
            <FormControl sx={{ width: '150px' }}>
              ...
              >
                ...
                <option value={1500}>2.0s</option>
                <option value={1500}>3.0s</option>
                <option value={1500}>5.0s</option>
              </NativeSelect>
            </FormControl>
          </div>
        </Grid>
