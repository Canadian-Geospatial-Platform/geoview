...
interface NorthArrowIconProps {
  ...
  height: number;
  /** The map identifier, used to keep the rendered group id unique across map instances. */
  mapId: string;
}
 ...
 */
export const NorthArrowIcon = memo((props: NorthArrowIconProps): JSX.Element => {
  ...
  return (
    <svg
      ...
      style={{ width, height }}
    >
      <g id={`${mapId}-northarrow`} transform="translate(-285.24 -142.234)">
        <path
        ...
        <path
          ...
          strokeWidth=".799"
        />
        <path d="M297.256 156.648v-8.525" fill="none" stroke="#000" strokeWidth=".067" />
        <path d="M297.258 143.48l8.793 22.432-8.811-8.812-8.812 8.812z" fill="#fff" stroke="#fff" strokeWidth=".912" />
        <path
        ...
        />
        <path d="M297.256 144.666l-7.726 19.568 7.726-7.726" fill="#6d6d6d" strokeWidth=".296" strokeLinecap="square" />
      </g>
    </svg>
  );
});
NorthArrowIcon.displayName = 'NorthArrowIcon';
 ...
 */
export const NorthPoleIcon = memo((): JSX.Element => {
  return (
...
NorthPoleIcon.displayName = 'NorthPoleIcon';
