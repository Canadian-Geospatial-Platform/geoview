...
export abstract class DateMgt {
  ...
  /** The international ISO date format. */
  static readonly ISO_TIME_FORMAT_SHORT = 'HH:mm';

  /** The international ISO datetime format. */
  static readonly ISO_DATETIME_FORMAT = 'YYYY-MM-DDTHH:mm:ss.SSS';

  /** The international ISO format without the milliseconds. */
  static readonly ISO_DATETIME_FORMAT_SHORT = 'YYYY-MM-DDTHH:mm:ss';

  /** A Default time only format for English and French */
  static readonly DEFAULT_TIME_FORMAT: TypeDisplayDateFormat = { en: DateMgt.ISO_TIME_FORMAT_SHORT, fr: DateMgt.ISO_TIME_FORMAT_SHORT };

  /** A Default time only format for English and French */
  static readonly DEFAULT_YEAR_ONLY_FORMAT: TypeDisplayDateFormat = { en: 'YYYY', fr: 'YYYY' };

  /** A Default date format for English and French */
  static readonly DEFAULT_DATE_FORMAT: TypeDisplayDateFormat = { en: 'MMM D, YYYY', fr: 'D MMM YYYY' };

  /** A Default date and time format for English and French */
  // static readonly DEFAULT_DATETIME_FORMAT: TypeDisplayDateFormat = { en: 'YYYY-MM-DD HH:mm:ss', fr: 'YYYY-MM-DD HH:mm:ss' };
  static readonly DEFAULT_DATETIME_FORMAT: TypeDisplayDateFormat = { en: 'MMM D, YYYY @ HH:mm', fr: 'D MMM YYYY @ HH:mm' };

  /** The default temporal mode */
  static readonly DEFAULT_TEMPORAL_MODE: TemporalMode = 'calendar';
   ...
   * @param {boolean} strict - Whether to enforce strict parsing when using
   * custom formats
  ...
  static parseCalendarDate(date: string, inputFormat?: string | string[], strict: boolean = false): Dayjs {
    ...
    // Create dayjs
    const parsed = this.#createDayjsFixCustomParser(date, formats, strict);
  ...
  static formatDate(
    date: DateLike,
    format: string = this.ISO_DATETIME_FORMAT,
  ...
  static formatDateISOShort(
    ...
    return this.formatDate(
      date,
      DateMgt.ISO_DATETIME_FORMAT_SHORT,
      'en',
      outputTimezone,
      temporalMode,
      inputFormat,
      ...
      if (validDates.length > 1) {
        ...
        if (timeDelta >= this.MILLISECONDS_IN_1_YEAR * 10) {
          ...
          return {
            ...
            displayDateFormatShort: this.DEFAULT_YEAR_ONLY_FORMAT,
          };
        }
