...
export class Notifications {
  ...
  showErrorGeoView(error: Error | unknown, withNotification: boolean = true, button: ISnackbarButton = {}): void {
    // TODO: Work in progress, discuss how we want to do this.... show a custom message vs show a generic message (obfuscating the real error) vs show the real error when it happens
    // If a GeoViewError
