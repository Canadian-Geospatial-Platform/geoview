...
export class ConfigValidation {
  ...
  private processLayerEntryConfig(
    ...
    listOfLayerEntryConfig.forEach((layerConfig: TypeLayerEntryConfig, i: number) => {
      ...
      (layerConfig as Exclude<TypeLayerEntryConfig, GeoCoreLayerEntryConfig>).geoviewLayerConfig = geoviewLayerConfig;
      // links the entry to its parent layer configuration.
      (layerConfig as Exclude<TypeLayerEntryConfig, GeoCoreLayerEntryConfig>).parentLayerConfig = parentLayerConfig;
      ...
      layerConfig.initialSettings = defaultsDeep(
        ...
        (layerConfig as Exclude<TypeLayerEntryConfig, GeoCoreLayerEntryConfig>).parentLayerConfig?.initialSettings ||
          (layerConfig as Exclude<TypeLayerEntryConfig, GeoCoreLayerEntryConfig>).geoviewLayerConfig?.initialSettings
      );
