...
export class OgcWmsLayerEntryConfig extends AbstractBaseLayerEntryConfig {
  ...
  constructor(layerConfig: OgcWmsLayerEntryConfig) {
    ...
    if (
      ...
      !this.geoviewLayerConfig.metadataAccessPath.startsWith('https://datacube.services.geo.ca')
    )
    ...
    if (
      ...
      !this.source.dataAccessPath.startsWith('https://datacube.services.geo.ca')
    )
