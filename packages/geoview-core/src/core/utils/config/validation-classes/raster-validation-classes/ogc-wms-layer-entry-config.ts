...
export class OgcWmsLayerEntryConfig extends AbstractBaseLayerEntryConfig {
  ...
  constructor(layerConfig: OgcWmsLayerEntryConfig) {
    ...
    if (layerConfig.geoviewLayerConfig.metadataAccessPath!.en!.slice(-4).toLowerCase() !== '.xml')
      this.source.dataAccessPath.en = layerConfig.geoviewLayerConfig.metadataAccessPath!.en;
    if (layerConfig.geoviewLayerConfig.metadataAccessPath!.fr!.slice(-4).toLowerCase() !== '.xml')
      this.source.dataAccessPath.fr = layerConfig.geoviewLayerConfig.metadataAccessPath!.fr;
