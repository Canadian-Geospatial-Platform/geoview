 ...
 * @deprecated This method should not be used directly. Favor a cleaner state adaptor method that
 * updates the store based on a specific event instead of setting the ordered layers directly.
 */
export const setStoreMapOrderedLayerInfoDirectly = (mapId: string, orderedLayerInfo: TypeOrderedLayerInfo[]): void => {
