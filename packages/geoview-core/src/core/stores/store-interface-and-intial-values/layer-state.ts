      ...
      setLegendLayers: (legendLayers: TypeLegendLayer[]): void => {
        set({
          layerState: {
            ...
            // GV We should improve this setter, apply it for different scenarios of actual specific 'sets', and the
            // new store selectors are compatible with this and should work fine in the future
          },
        });
      },
