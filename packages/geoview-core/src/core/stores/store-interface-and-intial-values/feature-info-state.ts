...
const subscriptions: SubscriptionDelegate[] = [];
...
export function initDetailsStateSubscriptions(store: GeoviewStoreType): void {
  ...
  subscriptions.push(...[layerDataArrayUpdateBatch, clickCoordinates, coordinateInfoEnabledSubscription]);
}

/**
 * Clears all active Zustand subscriptions for the details state.
 */
export function clearDetailsStateSubscriptions(): void {
