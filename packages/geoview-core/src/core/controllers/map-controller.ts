...
export class MapController extends AbstractMapViewerController {
   ...
   * @param includeFeatureInfo - Indicates if feature info should be included in the config for each layer; may increase time to create config
   ...
   * @param overrideGeocoreServiceNames - Indicates if geocore layer names should be kept as is or returned to defaults
   * @param includeFeatureInfo - Whether to include feature info in the config, which can be heavy to compute for many layers, so optional
  ...
  #createLayerEntryConfig(
    ...
    // Remove full feature info unless requested too reduce the size of the config file
