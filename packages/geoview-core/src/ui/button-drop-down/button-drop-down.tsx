 ...
 */
export type ButtonDropDownProps = ButtonGroupProps & { options: string[]; onButtonClick: (index: number, text: string) => void };
...
export function ButtonDropDown(props: ButtonDropDownProps): JSX.Element {
  ...
  return (
    <>
      <ButtonGroup {...props} sx={sxClasses.buttonDropDown} ref={anchorRef}>
