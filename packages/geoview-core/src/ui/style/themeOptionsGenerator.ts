  ...
  const themeOptions: ThemeOptions = {
    palette: {
      ...
      primary: {
        ...
        light: geoViewColors.primary.lighter,
        dark: geoViewColors.primary.dark,
      ...
      error: {
        ...
        light: geoViewColors.error.lighter,
        dark: geoViewColors.error.dark,
        contrastText: geoViewColors.error._contrastText(),
      },
      warning: {
        main: geoViewColors.warning.main,
        light: geoViewColors.warning.lighter,
        dark: geoViewColors.warning.dark,
        contrastText: geoViewColors.warning._contrastText(),
      },
      info: {
        main: geoViewColors.info.main,
        light: geoViewColors.info.lighter,
        dark: geoViewColors.info.dark,
        contrastText: geoViewColors.info._contrastText(),
      },
      success: {
        main: geoViewColors.success.main,
        light: geoViewColors.success.lighter,
        dark: geoViewColors.success.dark,
      ...
      tonalOffset: 0.2,
      text: {
        primary: geoViewColors.textColor.main,
        secondary: geoViewColors.textColor.darker,
