...
export type TypeButtonGroupConfig = {
  ...
  /** Optional display name for the group. Can be a single string or a localized record with values for each language. */
  displayName?: string | Record<TypeDisplayLanguage, string>;
};
