...
import { Cast, TypeJsonArray, TypeJsonObject, TypeJsonValue, toJsonObject } from '@config/types/config-types';
import {
  TypeDisplayLanguage,
...
export class ConfigApi {
   ...
   * @private
   */
  static #validateMinZoom(zoom?: number): number | undefined {
   ...
   * @private
   */
  static #validateMaxZoom(zoom?: number): number | undefined {
    return zoom && !Number.isNaN(zoom) && zoom >= 0 && zoom <= 18 ? zoom : undefined;
  }
   ...
   * @private
   */
  static #validateProjection(projection?: TypeValidMapProjectionCodes): TypeValidMapProjectionCodes {
   ...
   * @private
   */
  static #validateCenter(projection?: TypeValidMapProjectionCodes, center?: TypeJsonArray): [number, number] {
   ...
   * @private
   */
  static #validateExtent(projection: TypeValidMapProjectionCodes, extent: TypeJsonArray, center: [number, number]): Extent | undefined {
   ...
   * @private
   */
  static #doExtraValidation(listOfMapConfigLayerEntry?: TypeJsonArray): void {
   ...
   * @private
   */
  static #metadataAccessPathIsMandatory(geoviewLayerConfig: TypeJsonObject): void {
   ...
   * @private
   */
  static #geoviewLayerIdIsMandatory(geoviewLayerConfig: TypeJsonObject): void {
   ...
   * @private
   */
  static #processLocalizedString(suportedLanguages: TypeJsonArray, listOfMapConfigLayerEntry?: TypeJsonArray): void {
   ...
   * @private
   */
  static #adjustMapConfiguration(mapFeaturesConfigToAdjuste: TypeJsonObject): TypeJsonObject {
   ...
   * @private
   */
  static #logModifs(inputMapFeaturesConfig: TypeJsonObject, validMapFeaturesConfig: TypeJsonObject): void {
