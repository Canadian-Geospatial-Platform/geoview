...
import {
  ...
  type AbstractBaseLayerEntryConfigProps,
} from '@/api/config/validation-classes/abstract-base-layer-entry-config';
import type { TypeSourceImageWMTSInitialConfig, TypeWmtsConfig } from '@/geo/layer/geoview-layers/raster/wmts';
...
export class OgcWmtsLayerEntryConfig extends AbstractBaseLayerEntryConfig {
  tileMatrixSet?: string;
  /**
   ...
   */
  static isClassOrTypeWMTS(layerConfig: ConfigClassOrType | TypeGeoviewLayerConfig): layerConfig is TypeWmtsConfig {
    // Redirect
