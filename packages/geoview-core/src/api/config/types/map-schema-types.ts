...
/** Type from which we derive the source properties for all the CSV feature leaf nodes in the layer tree. */
export type TypeSourceCsvInitialConfig = TypeBaseVectorSourceInitialConfig;

/** Type from which we derive the source properties for all the XYZ tile feature leaf nodes in the layer tree. */
export type TypeSourceXyzInitialConfig = TypeSourceTileInitialConfig;

/** Type from which we derive the source properties for all the vector tile feature leaf nodes in the layer tree. */
export type TypeSourceVectorTileInitialConfig = TypeSourceTileInitialConfig;

/** Type from which we derive the source properties for all the OGC feature leaf nodes in the layer tree. */
export type TypeSourceOgcFeatureInitialConfig = TypeBaseVectorSourceInitialConfig;
