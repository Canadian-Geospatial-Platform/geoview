 ...
 */
export class OgcFeatureGroupLayerConfig extends GroupLayerEntryConfig {
  // ===============
  // #region METHODS
  /*
  ...
  override async fetchLayerMetadata(): Promise<void> {
    ...
    // OGC metadata doesn't provide group definition. So, we fetch the sub-layers immediately.
