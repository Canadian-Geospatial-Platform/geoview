...
export type EventType = 'click' | 'hover' | 'crosshaire-enter' | 'pointer-move' | 'all-features';
export const ArrayOfEventTypes: EventType[] = ['click', 'hover', 'crosshaire-enter', 'pointer-move', 'all-features'];
