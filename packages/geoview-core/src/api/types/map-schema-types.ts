...
export const VALID_DISPLAY_THEME: TypeDisplayTheme[] = ['dark', 'light', 'geo.ca', 'canada.ca'];
...
export type TypeOutfields = {
  ...
  /** Optional coded-value or range domain for the field. */
