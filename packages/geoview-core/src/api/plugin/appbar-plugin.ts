...
export abstract class AppBarPlugin extends AbstractPlugin {
  ...
  onAdd(): void {
    ...
    this.buttonPanel = this.mapViewer().appBarApi.createAppbarPanel(this.buttonProps!, this.panelProps, 'plugins') || undefined;
  }
  ...
  onRemove(): void {
    ...
    if (this.api && this.buttonPanel) {
      ...
      this.mapViewer().appBarApi.removeAppbarPanel(this.buttonPanel.buttonPanelId, 'plugins');
    }
  }
}
