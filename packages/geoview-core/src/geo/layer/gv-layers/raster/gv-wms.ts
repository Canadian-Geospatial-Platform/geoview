...
export class GVWMS extends AbstractGVRaster {
  ...
  /** The favored field titles to use when displaying feature info, in order of priority, most to least */
  static readonly DEFAULT_FAVORED_FIELD_TITLE: string[] = ['name', 'title', 'label', 'display', 'project_name', 'id', 'objectid', 'oid'];
  ...
  static #formatWmsFeatureInfoResultParser(
    ...
    const extractFields = (obj: any, prefix = ''): void => {
      ...
      if (!featureInfo.nameField) {
        ...
        featureInfo.nameField = GVWMS.DEFAULT_FAVORED_FIELD_TITLE.flatMap((title) =>
