...
export abstract class AbstractGVLayer extends AbstractBaseGVLayer {
   ...
   * @returns {unknown} The formatted value of the field.
   */
  protected static getFieldValue(
    ...
    // Redirect
    return AbstractGVLayer.helperGetFieldValue(feature, fieldName, fieldType, inputFormat, inputTimezone, inputTemporalMode);
  }
