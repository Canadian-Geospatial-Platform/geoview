...
export abstract class AbstractGeoViewLayer {
   ...
   *
   * @param {TypeQueryType} queryType Optional query type, default value is 'at_pixel'.
   * @param {string | TypeLayerEntryConfig | null} layerPathOrConfig Optional layer path or configuration.
   * @param {TypeLocation} location A pixel, a coordinate or a polygon that will be used by the query.
   *
   * @returns {Promise<TypeFeatureInfoResult>} The feature info table.
   */
  getFeatureInfo(
    queryType: TypeQueryType = 'at_pixel',
