...
export class GeoTIFF extends AbstractGeoViewRaster {
  ...
  protected override onCreateGVLayer(layerConfig: GeoTIFFLayerEntryConfig): GVGeoTIFF {
    ...
    void GeoTIFF.#initializeSourceMonitoring(source, layerConfig, gvLayer);
   ...
   * @private
   */
  static async #initializeSourceMonitoring(source: GeoTIFFSource, layerConfig: GeoTIFFLayerEntryConfig, gvLayer: GVGeoTIFF): Promise<void> {
