...
export class GeoTIFF extends AbstractGeoViewRaster {
  ...
  static async #initializeSourceProjection(source: GeoTIFFSource, layerConfig: GeoTIFFLayerEntryConfig): Promise<void> {
    try {
      ...
      // TODO: Check this call, unsure if the type is right, here projection is a string like 'EPSG:4326', calling Number() in that will make a NaN value, leaving it unchanged for now
