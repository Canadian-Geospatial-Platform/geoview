...
export class EsriFeature extends AbstractGeoViewVector {
  ...
  /**
   * Overrides the parent class's getter to provide a more specific return type (covariant return).
   * Sometimes, the layer processing uses metadata coming from MapServer/?f=json (TypeMetadataEsriDynamic) and sometimes
   ...
   * This function returns TypeMetadataEsriDynamic | TypeMetadataEsriDynamicLayer | TypeMetadataEsriFeature because sometimes the url is
