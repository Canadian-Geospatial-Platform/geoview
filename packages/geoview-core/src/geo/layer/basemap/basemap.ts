...
export class Basemap {
  ...
  createBasemapLayer = async (
    ...
    return {
      ...
      origin,
      extent,
      resolutions, // ? is this use somewhere, modifying values has no effect.
      minScale: minZoom, // ? is this use somewhere, modifying values has no effect.
      maxScale: maxZoom, // ? is this use somewhere, modifying values has no effect.
    };
  };
