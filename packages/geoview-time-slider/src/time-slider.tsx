...
export function TimeSlider(props: TimeSliderProps): JSX.Element {
  ...
  const { setValues, setLocked, setReversed, setDelay, setStep, setFiltering } = useTimeSliderStoreActions()!; // timeSliderStoreActions will always have a value here, ! to ignore possibility of undefined
