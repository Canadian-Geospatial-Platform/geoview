...
- When you use the _definite assignment assertion_ (! after a property declaration), include comments explaining why and indicating which code sections will affect the property.
