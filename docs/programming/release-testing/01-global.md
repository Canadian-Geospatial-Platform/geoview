...
| ------------------- | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | ---- |
| Panel full screen   | Footer bar panel expands to fill viewer | 1. Open each footer bar panel (Legend, Layers, Data Table, Details, Time Slider, Chart)<br>2. Click the full screen button<br>3. Press ESC or click again to exit | Panel expands to fill the viewer; ESC exits full screen | C    |
| Viewer full screen  | Entire map fills browser window         | 1. Click the viewer full screen button<br>2. Exit with ESC                                                                                                        | Map + footer bar fills the browser window               | C    |
