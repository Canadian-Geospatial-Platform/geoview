...
- [ ] **Line chart** — Verify line chart renders correctly with data points and axes.
- [ ] **Bar chart** — Verify bar chart renders with correct bars and labels.
- [ ] **Pie chart** — Verify pie chart renders with correct segments (if applicable).
...
- [ ] **CDTK geochart** — Verify the CDTK-style geochart renders correctly.

## Shortcut from Details

- [ ] **Details → Chart shortcut** — In the Details panel, click the chart shortcut. Verify the Geochart panel opens with data for the selected feature.
