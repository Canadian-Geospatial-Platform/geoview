...
> **Quick Start:** See [Creating Maps](app/doc-new/create-map.md) for basic usage examples  
...
Temporal layers automatically work with the Time Slider plugin. See [Packages](app/doc-new/packages.md#geoview-time-slider) for details.
...
- **[Creating Maps](app/doc-new/create-map.md)** - Map initialization and basic configuration
- **[GeoView Layers](app/doc-new/layers.md)** - Layer concepts and usage
- **[Layer API](app/doc-new/layer-api.md)** - Adding and managing layers
- **[Packages](app/doc-new/packages.md)** - Plugin-specific configuration
