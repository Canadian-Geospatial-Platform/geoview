...
> **📘 For Complete Plugin Guide:** See [Packages & Plugins Documentation](./doc-new/packages.md) for comprehensive API reference and modern plugin development patterns.
>
...
- **[Packages & Plugins Guide](./doc-new/packages.md)** - Complete plugin development guide with API reference
- **[Event Processors](./doc-new/event-processors.md)** - State management for plugins
- **[Package Examples](https://github.com/Canadian-Geospatial-Platform/geoview/tree/develop/packages)** - Real plugin implementations
