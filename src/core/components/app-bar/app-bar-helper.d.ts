...
export declare const helpOpenClosePanelByIdState: (buttonPanelGroups: ButtonPanelGroupType, buttonId: string, groupName: string | undefined, setterCallback: Dispatch<SetStateAction<ButtonPanelGroupType>>, status: boolean) => void;
export declare const helpOpenPanelById: (buttonPanelGroups: ButtonPanelGroupType, buttonId: string, groupName: string | undefined, setterCallback: Dispatch<SetStateAction<ButtonPanelGroupType>>) => void;
