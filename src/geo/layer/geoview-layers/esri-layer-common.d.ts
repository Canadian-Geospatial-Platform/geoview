...
export declare class EsriUtilities {
     ...
     * @deprecated Doesn't seem to be called anywhere.
     */
    static esriQueryRelatedRecordsByUrl(url: string, recordGroupIndex: number): Promise<TypeFeatureInfoEntryPartial[]>;
    /**
     * Asynchronously queries an Esri feature layer given the url and returns an array of `TypeFeatureInfoEntryPartial` records.
     * @param {string} url - An Esri url indicating a feature layer to query
     ...
     * @returns {TypeFeatureInfoEntryPartial[] | null} An array of relared records of type TypeFeatureInfoEntryPartial, or an empty array.
     */
    static esriQueryRecordsByUrl(url: string, geometryType?: TypeStyleGeometry, parseFeatureInfoEntries?: boolean): Promise<TypeFeatureInfoEntryPartial[]>;
    /**
     ...
     * @returns {TypeFeatureInfoEntryPartial[] | null} An array of relared records of type TypeFeatureInfoEntryPartial, or an empty array.
     */
    static esriQueryRecordsByUrlObjectIds(layerUrl: string, geometryType: TypeStyleGeometry, objectIds: number[], fields: string, geometry: boolean, outSR?: number, maxOffset?: number, parseFeatureInfoEntries?: boolean): Promise<TypeFeatureInfoEntryPartial[]>;
    /**
