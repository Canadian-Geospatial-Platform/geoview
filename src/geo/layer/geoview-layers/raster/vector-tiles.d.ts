...
export declare class VectorTiles extends AbstractGeoViewRaster {
     ...
     *
     * @param layerConfig - The layer entry config needed to create the Open Layer object.
     * @returns A promise that resolves with the GeoView raster layer that has been created.
     */
     ...
     */
    static createGeoviewLayerConfig(geoviewLayerId: string, geoviewLayerName: string | undefined, metadataAccessPath: string, isTimeAware: boolean | undefined, layerEntries: TypeLayerEntryShell[]): TypeVectorTilesConfig;
    /**
