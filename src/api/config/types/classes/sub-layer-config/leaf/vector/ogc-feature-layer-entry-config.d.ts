...
import { TypeLayerStyleConfig, TypeLayerEntryType, TypeBaseVectorSourceInitialConfig, AbstractGeoviewLayerConfig, EntryConfigBaseClass } from '@/api/config/types/map-schema-types';
 ...
 */
export declare class OgcFeatureLayerEntryConfig extends AbstractBaseLayerEntryConfig {
    #private;
     ...
     * @override @async
     */
    getGeoviewLayerConfig(): OgcFeatureLayerConfig;
    /**
