import { TypeLayerStyleConfig, TypeLayerEntryType, TypeSourceTileInitialConfig } from '@/api/config/types/map-schema-types';
 ...
 */
export declare class XyzLayerEntryConfig extends AbstractBaseLayerEntryConfig {
