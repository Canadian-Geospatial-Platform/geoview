...
export declare const layerEntryIsGroupLayer: (verifyIfLayer: ConfigClassOrType) => verifyIfLayer is GroupLayerEntryConfig;
export declare const layerConfigIsEsriDynamicFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeEsriDynamicLayerConfig;
export declare const layerEntryIsEsriDynamicFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is EsriDynamicLayerEntryConfig;
export declare const layerConfigIsEsriImageFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeEsriImageLayerConfig;
export declare const layerEntryIsEsriImageFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is EsriImageLayerEntryConfig;
export declare const layerConfigIsImageStaticFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeImageStaticLayerConfig;
export declare const layerEntryIsImageStaticFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is ImageStaticLayerEntryConfig;
export declare const layerConfigIsVectorTilesFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeVectorTilesConfig;
export declare const layerEntryIsVectorTileFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is VectorTilesLayerEntryConfig;
export declare const layerConfigIsOgcWmsFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeWMSLayerConfig;
export declare const layerEntryIsOgcWmsFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is OgcWmsLayerEntryConfig;
export declare const layerConfigIsXYZTilesFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeXYZTilesConfig;
export declare const layerEntryIsXYZTilesFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is XYZTilesLayerEntryConfig;
export declare const layerConfigIsCSVFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeCSVLayerConfig;
export declare const layerEntryIsCSVFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is CsvLayerEntryConfig;
export declare const layerConfigIsWKBFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeWkbLayerConfig;
export declare const layerEntryIsWKBFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is WkbLayerEntryConfig;
export declare const layerConfigIsEsriFeatureFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeEsriFeatureLayerConfig;
export declare const layerEntryIsEsriFeatureFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is EsriFeatureLayerEntryConfig;
export declare const layerConfigIsGeoJSONFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeGeoJSONLayerConfig;
export declare const layerEntryIsGeoJSONFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is GeoJSONLayerEntryConfig;
export declare const layerConfigIsOgcFeatureFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeOgcFeatureLayerConfig;
export declare const layerEntryIsOgcFeatureFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is OgcFeatureLayerEntryConfig;
export declare const layerConfigIsWFSFromType: (verifyIfLayer: TypeGeoviewLayerConfig) => verifyIfLayer is TypeWFSLayerConfig;
export declare const layerEntryIsWFSFromConfig: (verifyIfLayer: ConfigBaseClass | ConfigBaseClassProps) => verifyIfLayer is WfsLayerEntryConfig;
