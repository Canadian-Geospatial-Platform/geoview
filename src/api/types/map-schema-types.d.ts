...
export type TypeValidAppBarCoreProps = 'geolocator' | 'export' | 'aoi-panel' | 'about-panel' | 'custom-legend' | 'guide' | 'legend' | 'details' | 'data-table' | 'layers' | 'stac-browser' | 'filter-panel';
