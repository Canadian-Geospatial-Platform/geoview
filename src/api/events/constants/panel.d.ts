...
export declare type PanelEventKey = 'EVENT_PANEL_OPEN' | 'EVENT_PANEL_CLOSE' | 'EVENT_PANEL_CLOSE_ALL' | 'EVENT_PANEL_ADD_ACTION' | 'EVENT_PANEL_REMOVE_ACTION' | 'EVENT_PANEL_CHANGE_CONTENT';
