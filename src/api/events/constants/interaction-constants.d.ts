...
export type InteractionEventKey = 'EVENT_SELECTED' | 'EVENT_EXTENT' | 'EVENT_DRAW_STARTED' | 'EVENT_DRAW_ENDED' | 'EVENT_DRAW_ABORTED' | 'EVENT_MODIFY_STARTED' | 'EVENT_MODIFY_ENDED' | 'EVENT_TRANSLATE_STARTED' | 'EVENT_TRANSLATE_ENDED';
