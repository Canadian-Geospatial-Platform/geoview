...
export declare class GetLegendsPayload extends PayloadBaseClass {
     ...
     */
    static createLegendsLayersetUpdatedPayload: (handlerName: string, layerPath: string, resultsSet: TypeResultsSet | TypeLegendResultsSet) => TypeLegendsLayersetUpdatedPayload;
    /**
