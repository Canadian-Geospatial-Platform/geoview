 ...
 * Event names
 */
export type EventStringId = 'appbar/panel_create' | 'appbar/panel_remove' | 'attribution/update' | 'basemap/layers_update' | 'details_panel/crosshair_enter' | 'drawer/open_close' | 'footerbar/expand_collapse' | 'footer_tabs/tab_create' | 'footer_tabs/tab_remove' | 'get_feature_info/all_queries_done' | 'get_feature_info/query_layer' | 'get_feature_info/query_result' | 'get_legends/all_legends_done' | 'get_legends/legend_info' | 'get_legends/query_legends' | 'get_legends/trigger' | 'layer_set/layer_registration' | 'layer_set/request_layer_inventory' | 'layer_set/updated' | 'layer/add' | 'layer/added' | 'layer/get_layers' | 'layer/remove' | 'layer/if_condition' | 'map/add_component' | 'map/crosshair_enable_disable' | 'map/fix_north' | 'map/inkeyfocus' | 'map/loaded' | 'map/moveend' | 'map/reload' | 'map/remove_component' | 'map/singleclick' | 'map/view_projection_change' | 'map/zoomend' | 'marker_icon/hide' | 'marker_icon/show' | 'modal/close' | 'modal/create' | 'modal/open' | 'modal/update' | 'navbar/button_panel_create' | 'navbar/button_panel_remove' | 'navbar/toggle_controls' | 'overview_map/toggle' | 'panel/add_action' | 'panel/change_content' | 'panel/close' | 'panel/close_all' | 'panel/open' | 'panel/remove_action' | 'slider/on_change_value' | 'slider/set_min_max' | 'slider/set_values' | 'snackbar/open' | 'vector/add' | 'vector/added' | 'vector/off' | 'vector/on' | 'vector/remove';
