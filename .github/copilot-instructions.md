 ...
 * @returns {Promise} Promise of config nodes
 */
```
...
- **Return values** - Use `@returns` for all functions that return values; describe what the Promise resolves to for async functions
